...
- **[docs/reference/](docs/reference/)** — `commands.md` (177 Tauri commands), `events.md`, `hooks.md`, `settings.md`
...
| File | Purpose |
|------|---------|
| `lib.rs` | App wiring: mod declarations, `State`, `MutexExt`, 177 registered commands, setup, tray, `run()` |
