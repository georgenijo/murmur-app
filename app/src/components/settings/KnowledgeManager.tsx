        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-xl text-xs text-on-surface-variant">
              Manage local replacement rules, vocabulary, and reusable snippets. Enabled replacement rules run through Smart Correction with deterministic scope and provenance precedence.
            </p>
          </div>
