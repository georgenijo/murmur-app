        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-xl text-xs text-on-surface-variant">
              Manage local replacement rules, vocabulary, and reusable snippets. Scope controls where a future lookup may use each record; this page does not alter transcription yet.
            </p>
          </div>
