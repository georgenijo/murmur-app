...
export function MeetingDiarizationSettings({
  ...
  return (
    <div data-setting-target="meeting-speakers" className="space-y-3 rounded-lg transition-shadow [&.settings-target-flash]:ring-2 [&.settings-target-flash]:ring-primary/40">
