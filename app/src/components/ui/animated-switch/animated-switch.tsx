  ...
  return (
    <Switch.Root
      ...
      className={cn(
        ...
        sizes.track,
        "data-[checked]:bg-primary data-[unchecked]:bg-surface-container-highest",
    ...
    >
      <Switch.Thumb
        className={cn(
          "block rounded-full shadow-lg ring-0",
          "[[data-checked]>&]:bg-on-primary [[data-unchecked]>&]:bg-on-surface-variant",
          sizes.thumb,
        )}
        render={
          <motion.span
