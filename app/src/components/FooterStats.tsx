...
export function FooterStats({ statsVersion }: FooterStatsProps) {
  ...
  return (
    <footer className="relative flex h-[44px] shrink-0 items-center gap-2 border-t border-outline-variant/15 bg-background/95 px-5 text-xs text-on-surface-variant">
      ...
      <div ref={shellRef} className="relative ml-auto">
        <button
          ...
          aria-expanded={open}
          className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-[11px] font-bold uppercase tracking-[0.12em] text-on-surface-variant transition-colors hover:bg-surface-container-low hover:text-on-surface focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
          Insights
