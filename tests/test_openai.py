#!/usr/bin/env python3
"""
Test all OpenAI Whisper model weights.

Usage:
    python tests/test_openai.py <audio_file> --reference "the actual words spoken"
    python tests/test_openai.py test_audio.wav --reference "hello world this is a test"
"""
...
# All available OpenAI Whisper models
MODELS = [
    "tiny.en",
    "base.en",
    "small.en",
...
def test_model(model_name: str, audio_path: str, reference: str = None) -> dict:
    ...
    print(f"\n{'='*60}")
    print(f"Testing OpenAI Whisper: {model_name}")
    print('='*60)
...
def main(audio_path: str = None, reference: str = None):
    parser = argparse.ArgumentParser(description="Test OpenAI Whisper models")
    ...
    if not audio_path:
        print("Usage: python tests/test_openai.py <audio_file> --reference \"transcript\"")
        print()
        print("Example:")
        print("  python tests/test_openai.py test_audio.wav --reference \"hello world\"")
        print()
    ...
    print(f"Testing {len(MODELS)} OpenAI Whisper models...")
    ...
    print("\n")
    print("="*80)
    print("OPENAI WHISPER MODEL COMPARISON")
    print("="*80)
