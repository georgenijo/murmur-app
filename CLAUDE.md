...
- **[docs/reference/](docs/reference/)** — `commands.md` (126 Tauri commands), `events.md`, `hooks.md`, `settings.md`
...
| File | Purpose |
|------|---------|
| `lib.rs` | App wiring: mod declarations, `State`, `MutexExt`, 126 registered commands, setup, tray, `run()` |
