...
- **[docs/reference/](docs/reference/)** — `commands.md` (112 Tauri commands), `events.md`, `hooks.md`, `settings.md`
...
| File | Purpose |
|------|---------|
| `lib.rs` | App wiring: mod declarations, `State`, `MutexExt`, 112 registered commands, setup, tray, `run()` |
