...
- **[docs/reference/](docs/reference/)** — `commands.md` (170 Tauri commands), `events.md`, `hooks.md`, `settings.md`
...
| File | Purpose |
|------|---------|
| `lib.rs` | App wiring: mod declarations, `State`, `MutexExt`, 170 registered commands, setup, tray, `run()` |
